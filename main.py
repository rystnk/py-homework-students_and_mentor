...
reviewer_1.rate_hw(ivanov, 'Python', 6)
reviewer_2.rate_hw(petrov, 'Python', 6)
...
ivanov.rate_lecture(lecturer_1, 'Python', 6)
ivanov.rate_lecture(lecturer_2, 'Python', 8)

#Добавляем пройденный курс студенту
petrov.add_courses('SQL')

#Рассчитываем средние оценки для сутеднтов за курс Python
Student.average_grades_hw([petrov, ivanov], 'Python')
